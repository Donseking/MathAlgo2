...
from mathalgo2.Code import ClassicalCipher, CodeBase, ModernCipher
...
class TestModernCipher:
    ...
    def test_rsa_basic(self, sample_text, rsa_keys):
        ...
        encrypted = ModernCipher.rsa_encrypt(
            sample_text, public_key, show_progress=False
        )
